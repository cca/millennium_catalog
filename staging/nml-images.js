...
/* <script language="JavaScript" type="text/javascript" src="/screens/nml-images.js"></script>*/
...
for (var i=0; i < spans.length; i++) //loop through all spans
{
	...
	if (spans[i].className=="UPC") { // if span class is UPC plug span content into content cafe link and image
			...
			var isbnimage = "<span class='bookjacket'><a href='http://libraries.cca.edu/nml-images/" + isbn + ".jpg' target='_parent'><img src='http://libraries.cca.edu/nml-images/" + isbn + "' border='0' alt='book jacket'></a></span>";
...
for(var k = 0; k < divs.length; k++) {
	...
	for (var i=0; i < spans.length; i++) //loop through all spans
	{
		if (spans[i].className=="UPC" && upc != "") {
			...
			var isbnimage = "<span class='bookjacket'><a href='http://libraries.cca.edu/nml-images/" + isbn + "' target='_parent'><img src='http://libraries.cca.edu/nml-images/" + isbn + "' border='0' alt='book jacket'></a></span>";
			spans[i].innerHTML = isbnimage;
			}
			else if (isbn ==""){
				spans[i].innerHTML = "";
