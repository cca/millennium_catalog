...
/* <script src="/screens/book-jacket.js"></script>*/
		...
		for (var l = 0; l < images.length; l++) {
			if (images[l].alt == "book jacket") {
				...
				if (upc != "" && upc != undefined) { // if there's a upc, change the link and the img src
					hrefupc =
						"http://contentcafe2.btol.com/ContentCafe/Jacket.aspx?UserID=CCA49068&Password=CC63500&Return=1&Type=L&Value=" +
						upc;
					images[l].parentNode.setAttribute('href', hrefupc);
					images[l].src =
						"http://contentcafe2.btol.com/ContentCafe/Jacket.aspx?UserID=CCA49068&Password=CC63500&Return=1&Type=S&Value=" +
						upc + "&erroroverride=1&";
